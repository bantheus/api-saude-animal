...
export const getAll = async (req: Request<{}, {}, {}, IQueryProps>, res: Response) => {
  const result = await animaisProviders.getAll(req.query.page || 1, req.query.limit || 10, req.query.filter || "", req.query.id || "");

  const count = await animaisProviders.count(req.query.filter);
