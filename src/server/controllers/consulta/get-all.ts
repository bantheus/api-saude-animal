...
export const getAll = async (req: Request<{}, {}, {}, IQueryProps>, res: Response) => {
  const result = await consultaProviders.getAll(req.query.page || 1, req.query.limit || 10, req.query.filter || "", req.query.id || "");

  const count = await consultaProviders.count(req.query.filter);
